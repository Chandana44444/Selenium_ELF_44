...
public class WorkingWithActionsClassMthds
{
	public static void main(String[] args) 
	{
		...
		driver1.get("https://www.foodpanda.com/");
		List<WebElement> all_nav_ele = driver1.findElements(By.xpath("//ul[@id=\"menu-primary\"]/li[not(contains(.,'Choose Location'))]"));
...
//			
		...
		if(driver1.getTitle().contains("panda ads"))
		{
			driver1.close();
			break;
		}
