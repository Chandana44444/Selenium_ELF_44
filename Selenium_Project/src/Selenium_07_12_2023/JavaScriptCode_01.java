...
public class JavaScriptCode_01 
{
	public static void main(String[] args) 
	{
		...
		WebElement disabled_button = driver1.findElement(By.xpath("//input[@class=\"form-control\"]"));
		driver1.executeScript("arguments[0].value='Selenium';", disabled_button);
